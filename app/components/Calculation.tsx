...
import {
  InputLabel, FormControl, Select, Grid, Button, Typography,
  FormControlLabel, RadioGroup, Radio, ThemeProvider
...
const rows = [createData("strongly disagree", 0), createData("disagree", 1),
createData("neutral", 2), createData("agree", 3),
...
export default function Calculation(): JSX.Element {
  ...
  const checkWeighted = (): boolean => {
    ...
    if (["Fleiss' Kappa", "Krippendorff's Alpha", "Percentage Agreement"].includes(measure)) {
  ...
  return (
    <ThemeProvider theme={theme1}>
      ...
      >
        <Grid item container xs={3} direction="column" justify="flex-start"
          ...
          <Grid item>
            <FormControl variant="outlined" style={{ width: 180 }}>
              <InputLabel htmlFor="outlined-age-native-simple">Measure</InputLabel>
              <Select
                native
                label="measure"
                inputProps={{
              ...
              >
                ...
                <option value={"Krippendorff's Alpha"}>Krippendorff's Alpha</option>
                <option value={"Percentage Agreement"}>Percentage Agreement</option>
                <option value={"Scott's Pi"}>Scott's Pi</option>
                <option value={"Fleiss' Kappa"}>Fleiss' Kappa</option>
              </Select>
            </FormControl>
          </Grid>
          {["Krippendorff's Alpha", "Fleiss' Kappa", "Percentage Agreement"].includes(measure) &&
            <Grid item>
              ...
              <RadioGroup
                ...
                row
              >
                <FormControlLabel value="nominal" control={<Radio color="default" />} label="nominal" />
                <FormControlLabel value="ordinal" control={<Radio color="default" />} label="ordinal" />
              </RadioGroup>
            </Grid>}
          <Grid item>
            <input
            ...
            <Typography variant="subtitle1"
              style={{ color: "gray", maxWidth: 180, maxHeight: 30, overflow: "auto" }}>
              {data}
            </Typography>
          </Grid>
          <Grid item>
        ...
        <Grid item container xs={9} direction="column" justify="flex-start"
          spacing={3}>
          <Grid item style={{ marginBottom: 10 }}>
            <Typography variant="h6" style={{ color: "gray" }}>
              INFORMATION
          ...
          <Grid item>
            <Typography variant="subtitle1" style={{ color: "gray" }}>
              This section displays the essential information extracted from the files uploaded in SETTINGS. Please confirm it before pressing OK. It is recommended to refer the documentation for requirements on the file format.
            </Typography>
          </Grid>
